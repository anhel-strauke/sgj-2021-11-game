...
label chapter_8:
    ...
    ph8_long "Да-да. Ей было очень интересно, почему ты отказалась воспользоваться гостеприимством и сбежала с её деньгами?"

    h8 "Ох… Простите, госпожа Амелинда."

    pause 1.0

    ph8_long "Не волнуйся, Мэллори. Я давно знаю эту женщину и уверяю тебя, что ты всё сделала верно."
    ...
    ph8_long "Вот и оставь их себе. Но впредь пообещай мне, что будешь более обходительна с клиентами."
